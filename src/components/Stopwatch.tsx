    ...
    <div className="stopwatch">
      ...
      <div className="flex justify-center mt-10">
        <div className="text-center text-2xl flex justify-around w-[600px] items-center">
          {!isRunning ? (
            <button onClick={handleStart} className="p-8">
              Start
            </button>
          ) : (
            <button onClick={handleStop} className="p-8">
              Stop
            </button>
          )}
          <button onClick={handleReset} className="p-8">
            Reset
          </button>
          <button onClick={handleLap} disabled={!isRunning} className="p-8">
            Lap
          </button>
        </div>
      </div>
